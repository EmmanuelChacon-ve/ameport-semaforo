...
export default function ComGantt() {
    ...
    const filtered = useMemo(() => {
        ...
        return r;
    }, [tasksWithStatus, semaforoFilter, categoryFilter, unreadFilter, hasUnread, getDeptDetailedStatus]);
                    ...
                    <div className="cgantt__filter-buttons">
                        {DETAILED_STATUS_FILTERS.map((s) => (
                            <button key={s} className={`cgantt__filter-btn ${semaforoFilter === s ? 'cgantt__filter-btn--active' : ''}`}
                                ...
                                <span className="cgantt__filter-dot" /><span>{STATUS_CONFIG[s].label}</span>
