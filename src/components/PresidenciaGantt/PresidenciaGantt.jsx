...
const DEPT_NAME = 'Presidencia';

export default function PresidenciaGantt() {
    ...
    const { tasks: tasksWithStatus, categories: presCategories, categoryColors, departments, loading, refetch } = useGanttData(DEPT_NAME);
    const {
        isAdmin, canCreate,
    ...
    const categoryCounts = useMemo(() => {
        const c = {};
        presCategories.forEach((cat) => (c[cat] = 0));
        tasksWithStatus.forEach((t) => c[t.category]++);
        return c;
    }, [tasksWithStatus, presCategories]);
        ...
        <div className="fgantt">
            ...
            <div className="gantt__toolbar">
                ...
                <div className="gantt__toolbar-actions">
                    {isAdmin && (
                        <button className="grid-print-btn" onClick={() => printTable(tableRef.current, 'Presidencia')}>
