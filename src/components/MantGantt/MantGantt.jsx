...
import { monthNames, statusLabels, semaforoColors, frequencyColors, STATUS_CONFIG, DETAILED_STATUS_FILTERS } from '../../utils/semaforoUtils';
                    ...
                    <div className="mgantt__filter-buttons">
                        {DETAILED_STATUS_FILTERS.map((s) => (
                            <button key={s} className={`mgantt__filter-btn ${semaforoFilter === s ? 'mgantt__filter-btn--active' : ''}`}
                                ...
                                <span className="mgantt__filter-dot" /><span>{STATUS_CONFIG[s].label}</span>
